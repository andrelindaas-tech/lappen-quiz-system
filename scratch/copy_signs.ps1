$sourceDir = "C:\Users\andre.lindaas\OneDrive - Made for Movement Group AS\Documents\New project\public\signs\opplysningsskilt"
$destDir = "C:\Users\andre.lindaas\Documents\lappen-quiz-system\public\signs\opplysningsskilt"
$files = @(
...
foreach ($file in $files) {
    Copy-Item "$sourceDir\$file" -Destination "$destDir\$file" -Force
}
Write-Output "Copied $($files.Count) files successfully!"
